...
"""Generate sales and product barchart reports"""

# Function to generate daily sales barchart
def daily_sales():
...
# Function to generate product sales count barchart
def product_sales():
    df = pd.read_csv(inp.database_file(inp.file_name))
    ...
    plt.ylabel("Product_Price", labelpad=11)
